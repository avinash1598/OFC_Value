...
for i = 1:length(folders)
    ...
    for action=[-1, 1] % -1 for left and 1 for right
        ...
        % Save data to file
        if action == -1 % Left
            dataToSave.left.LOFC.pValOverall = regressionAnalysisDataLOFC.pValOverall;
            dataToSave.left.LOFC.pValTrialNumbers = regressionAnalysisDataLOFC.pValTrialNumbers;
            dataToSave.left.LOFC.pValTrialValue = regressionAnalysisDataLOFC.pValTrialValue;
            dataToSave.left.LOFC.pValActionPerformed = regressionAnalysisDataLOFC.pValActionPerformed;
            dataToSave.left.LOFC.timeBins = timeBinsLOFC;
        
            dataToSave.left.ROFC.pValOverall = regressionAnalysisDataROFC.pValOverall;
            dataToSave.left.ROFC.pValTrialNumbers = regressionAnalysisDataROFC.pValTrialNumbers;
            dataToSave.left.ROFC.pValTrialValue = regressionAnalysisDataROFC.pValTrialValue;
            dataToSave.left.ROFC.pValActionPerformed = regressionAnalysisDataROFC.pValActionPerformed;
            dataToSave.left.ROFC.timeBins = timeBinsROFC;

        elseif action == 1 % Right
            dataToSave.right.LOFC.pValOverall = regressionAnalysisDataLOFC.pValOverall;
            dataToSave.right.LOFC.pValTrialNumbers = regressionAnalysisDataLOFC.pValTrialNumbers;
            dataToSave.right.LOFC.pValTrialValue = regressionAnalysisDataLOFC.pValTrialValue;
            dataToSave.right.LOFC.pValActionPerformed = regressionAnalysisDataLOFC.pValActionPerformed;
            dataToSave.right.LOFC.timeBins = timeBinsLOFC;
            
            dataToSave.right.ROFC.pValOverall = regressionAnalysisDataROFC.pValOverall;
            dataToSave.right.ROFC.pValTrialNumbers = regressionAnalysisDataROFC.pValTrialNumbers;
            dataToSave.right.ROFC.pValTrialValue = regressionAnalysisDataROFC.pValTrialValue;
            dataToSave.right.ROFC.pValActionPerformed = regressionAnalysisDataROFC.pValActionPerformed;
